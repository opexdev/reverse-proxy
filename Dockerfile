...
ENV SERVER_NAME_STATUS status.opex.dev
...
\$EXPOSED_PORT,\$SERVER_NAME_DASHBOARD,\$SERVER_NAME_ADMIN_PANEL,\$SERVER_NAME_WEB_APP,\$SERVER_NAME_AUTH,\$SERVER_NAME_STATUS,\$SERVER_NAME_API,\$SERVER_NAME_MOBILE_APP,\$SERVER_NAME_GRAFANA,\$SERVER_NAME_KIBANA \
